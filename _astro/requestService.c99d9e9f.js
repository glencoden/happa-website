import{a as i,M as _,F as p,g as o,j as D,t as c,b as R,i as S,d as f,e as A}from"./web.7422b675.js";import{p as I,l as k,L as e}from"./Text.e6e267e5.js";import{B as E,a as L}from"./Button.8c23db01.js";import{L as T}from"./Link.dd352ffb.js";const v="_bold_uz1c4_1",w={bold:v},B=c("<span>Loading..."),G=c("<span>"),y=c("<div>Loading..."),U=c("<br>"),b=({item:n})=>i(p,{get each(){return n.children},get fallback(){return o(B)},children:t=>{const r=[],s=[];t.marks.forEach(l=>{switch(l){case"strong":r.push(w.bold);break;default:s.push(l);break}});const d=r.length===0?R(()=>t.text):(()=>{const l=o(G);return S(l,()=>t.text),f(()=>A(l,r.join(" "))),l})(),m=n.markDefs.find(l=>l._key===s[0]);switch(m?._type){case"link":return i(T,{get linkUrl(){return m.href},get children(){return i(E,{get size(){return L.Regular},children:d})}});default:return d}}}),F=({en:n,de:t})=>{const r=I(k);return i(D,{get children(){return[i(_,{get when(){return r()===e.English},get children(){return i(p,{each:n,get fallback(){return o(y)},children:s=>[i(b,{item:s}),o(U)]})}}),i(_,{get when(){return r()===e.German},get children(){return i(p,{each:t,get fallback(){return o(y)},children:s=>[i(b,{item:s}),o(U)]})}})]}})},u=n=>Array.isArray(n)?n.map(t=>!Array.isArray(t.children)||!Array.isArray(t.markDefs)?(console.warn("unexpected parser input:",t),{children:[],markDefs:[]}):{children:t.children,markDefs:t.markDefs.map(r=>({href:r.href??"",_key:r._key??"",_type:r._type??""}))}):(console.warn("unexpected parser input:",n),[]),P=n=>{const t=n?.result;return!Array.isArray(t)||t.length===0?(console.warn("unexpected parser input:",n),null):{description:{[e.English]:u(t[0].description?.en),[e.German]:u(t[0].description?.de)},imageUrls:Array.isArray(t[0].imageUrls)?t[0].imageUrls:[]}},a=n=>{const t=n?.result;return Array.isArray(t)?t.length===0?{title:{[e.English]:"",[e.German]:""},subtitle:null,date:null,content:{[e.English]:[],[e.German]:[]},buttonText:null,buttonLink:null,imageUrl:""}:{title:{[e.English]:t[0].title?.en||"",[e.German]:t[0].title?.de||""},subtitle:t[0].subtitle?{[e.English]:t[0].subtitle.en||"",[e.German]:t[0].subtitle.de||""}:null,date:t[0].date||null,content:{[e.English]:u(t[0].description?.en),[e.German]:u(t[0].description?.de)},buttonText:t[0].buttonText?{[e.English]:t[0].buttonText.en||"",[e.German]:t[0].buttonText.de||""}:null,buttonLink:t[0].buttonLink||null,imageUrl:t[0].imageUrl||""}:(console.warn("unexpected parser input:",n),null)},h=(n,t)=>{const r=n?.result;return Array.isArray(r)?r.map(s=>t({result:[s]})):(console.warn("unexpected parser input:",n),null)},x=n=>{const t=n?.result;return!Array.isArray(t)||t.length===0?(console.warn("unexpected parser input:",t),null):{title:{[e.English]:t[0].title?.en||"",[e.German]:t[0].title?.de||""},menu:{[e.English]:u(t[0].menu?.en),[e.German]:u(t[0].menu?.de)},buttonText:t[0].buttonText?{[e.English]:t[0].buttonText.en||"",[e.German]:t[0].buttonText.de||""}:null,buttonLink:t[0].buttonLink||null}},g=n=>{const t=n?.result;return!Array.isArray(t)||t.length===0?(console.warn("unexpected parser input:",t),null):{title:{[e.English]:t[0].title?.en||"",[e.German]:t[0].title?.de||""},text:{[e.English]:u(t[0].text?.en),[e.German]:u(t[0].text?.de)}}},$="hwz0ma01",H="production",M=`https://${$}.api.sanity.io/v2021-10-21/data/query/${H}`;class C{_get(t){return fetch(t).then(r=>r.json()).catch(console.error)}_createSanityUrl(t){return`${M}?query=${t}`}getHomeBannerData(){const t=this._createSanityUrl(encodeURI(`
                *[_type == "homeBanner"]{
                    title,
                    subtitle,
                    description,
